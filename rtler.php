...
<div class="wrap">
	...
	<div style="float:right; margin: 5px;"><?php _e(sprintf( 'Version %s by', '1.3' ), 'rtler'); ?> <a href="http://louyblog.wordpress.com/">Louy Alakkad</a></div>
	...
	<table class="form-table">
		...
		<tr valign="top">
			...
			<td>
				...
				<small><?php _e('<strong>Note:</strong> Due to the weak CSS support, For now you need to manually remove the .alignright and .alignleft and the .fr and .fl from your rtl.css, You won&#39;t need to in the future versions. :/', 'rtler'); ?></small>
			</td>
		</tr>
	</table>
